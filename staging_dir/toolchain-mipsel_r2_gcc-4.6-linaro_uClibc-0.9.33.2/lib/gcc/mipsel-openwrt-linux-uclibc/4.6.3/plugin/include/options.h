...
enum opt_code
{
  ...
  OPT_fsched_rank_heuristic = 764,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 765,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 766,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 767,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 768,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 769,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 770,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 771,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 772,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 773,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 774,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 775, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 776,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 777,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 778,              /* -fsecond-underscore */
  OPT_fsection_anchors = 779,                /* -fsection-anchors */
  /* OPT_fsee = 780, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 781,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 782,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 783, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 784,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 785,          /* -fselective-scheduling2 */
  OPT_fshort_double = 786,                   /* -fshort-double */
  OPT_fshort_enums = 787,                    /* -fshort-enums */
  OPT_fshort_wchar = 788,                    /* -fshort-wchar */
  OPT_fshow_column = 789,                    /* -fshow-column */
  OPT_fsign_zero = 790,                      /* -fsign-zero */
  OPT_fsignaling_nans = 791,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 792,               /* -fsigned-bitfields */
  OPT_fsigned_char = 793,                    /* -fsigned-char */
  OPT_fsigned_zeros = 794,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 795,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 796,               /* -fsource-filename= */
  OPT_fsource_ = 797,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 798,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 799,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 800,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 801, */                 /* -fsquangle */
  ...
  OPT_fstack_usage = 809,                    /* -fstack-usage */
  OPT_fstats = 810,                          /* -fstats */
  OPT_fstore_check = 811,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 812, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 813,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 814,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 815,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 816, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 817,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 818,                    /* -fsyntax-only */
  OPT_ftabstop_ = 819,                       /* -ftabstop= */
  /* OPT_ftarget_help = 820, */              /* -ftarget-help */
  OPT_ftarget_ = 821,                        /* -ftarget= */
  ...
  OPT_ftrapping_math = 832,                  /* -ftrapping-math */
  OPT_ftrapv = 833,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 834,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 835,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 836,                       /* -ftree-ccp */
  OPT_ftree_ch = 837,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 838,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 839,                /* -ftree-copyrename */
  OPT_ftree_cselim = 840,                    /* -ftree-cselim */
  OPT_ftree_dce = 841,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 842,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 843,                       /* -ftree-dse */
  OPT_ftree_forwprop = 844,                  /* -ftree-forwprop */
  OPT_ftree_fre = 845,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 846,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 847,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 848,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 849,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 850,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 851,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 852, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 853,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 854,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 855,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 856,                   /* -ftree-phiprop */
  OPT_ftree_pre = 857,                       /* -ftree-pre */
  OPT_ftree_pta = 858,                       /* -ftree-pta */
  OPT_ftree_reassoc = 859,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 860, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 861,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 862,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 863,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 864,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 865, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 866, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 867,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 868,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 869,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 870,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 871,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 872,                       /* -ftree-vrp */
  OPT_funderscoring = 873,                   /* -funderscoring */
  OPT_funit_at_a_time = 874,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 875,               /* -funroll-all-loops */
  OPT_funroll_loops = 876,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 877,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 878,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 879,             /* -funsigned-bitfields */
  OPT_funsigned_char = 880,                  /* -funsigned-char */
  OPT_funswitch_loops = 881,                 /* -funswitch-loops */
  OPT_funwind_tables = 882,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 883,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 884,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 885,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 886,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 887,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 888,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 889,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 890,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 891,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 892,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 893, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 894,                /* -fvect-cost-model */
  OPT_fverbose_asm = 895,                    /* -fverbose-asm */
  /* OPT_fversion = 896, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 897,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 898,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 899,                    /* -fvisibility= */
  OPT_fvpt = 900,                            /* -fvpt */
  /* OPT_fvtable_gc = 901, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 902, */            /* -fvtable-thunks */
  OPT_fweak = 903,                           /* -fweak */
  OPT_fweb = 904,                            /* -fweb */
  OPT_fwhole_file = 905,                     /* -fwhole-file */
  OPT_fwhole_program = 906,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 907,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 908,              /* -fworking-directory */
  OPT_fwpa = 909,                            /* -fwpa */
  OPT_fwrapv = 910,                          /* -fwrapv */
  /* OPT_fxref = 911, */                     /* -fxref */
  OPT_fzee = 912,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 913,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 914,                      /* -fzero-link */
  OPT_g = 915,                               /* -g */
  OPT_gant = 916,                            /* -gant */
  OPT_gcoff = 917,                           /* -gcoff */
  OPT_gdwarf_ = 918,                         /* -gdwarf- */
  OPT_gen_decls = 919,                       /* -gen-decls */
  OPT_ggdb = 920,                            /* -ggdb */
  OPT_gnat = 921,                            /* -gnat */
  OPT_gnatO = 922,                           /* -gnatO */
  OPT_gno_strict_dwarf = 923,                /* -gno-strict-dwarf */
  OPT_gstabs = 924,                          /* -gstabs */
  OPT_gstabs_ = 925,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 926,                   /* -gstrict-dwarf */
  OPT_gtoggle = 927,                         /* -gtoggle */
  OPT_gvms = 928,                            /* -gvms */
  OPT_gxcoff = 929,                          /* -gxcoff */
  OPT_gxcoff_ = 930,                         /* -gxcoff+ */
  OPT_h = 931,                               /* -h */
  OPT_idirafter = 932,                       /* -idirafter */
  OPT_imacros = 933,                         /* -imacros */
  ...
  OPT_print_objc_runtime_info = 1045,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1046,               /* -print-prog-name= */
  OPT_print_search_dirs = 1047,              /* -print-search-dirs */
  OPT_print_sysroot = 1048,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1049,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1050,                        /* -profile */
  OPT_pthread = 1051,                        /* -pthread */
  OPT_quiet = 1052,                          /* -quiet */
  OPT_r = 1053,                              /* -r */
  OPT_rdynamic = 1054,                       /* -rdynamic */
  ...
  OPT_std_c__98 = 1072,                      /* -std=c++98 */
  OPT_std_c1x = 1073,                        /* -std=c1x */
  /* OPT_std_c89 = 1074, */                  /* -std=c89 */
  OPT_std_c90 = 1075,                        /* -std=c90 */
  OPT_std_c99 = 1076,                        /* -std=c99 */
  /* OPT_std_c9x = 1077, */                  /* -std=c9x */
  OPT_std_f2003 = 1078,                      /* -std=f2003 */
  OPT_std_f2008 = 1079,                      /* -std=f2008 */
  OPT_std_f95 = 1080,                        /* -std=f95 */
  OPT_std_gnu = 1081,                        /* -std=gnu */
  OPT_std_gnu__0x = 1082,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1083,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1084,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1085, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1086,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1087,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1088, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1089, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1090,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1091, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1092, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1093,                     /* -std=legacy */
  OPT_symbolic = 1094,                       /* -symbolic */
  OPT_t = 1095,                              /* -t */
  OPT_time = 1096,                           /* -time */
  OPT_time_ = 1097,                          /* -time= */
  OPT_tno_android_cc = 1098,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1099,                 /* -tno-android-ld */
  OPT_traditional = 1100,                    /* -traditional */
  OPT_traditional_cpp = 1101,                /* -traditional-cpp */
  OPT_trigraphs = 1102,                      /* -trigraphs */
  OPT_u = 1103,                              /* -u */
  OPT_undef = 1104,                          /* -undef */
  OPT_v = 1105,                              /* -v */
  OPT_version = 1106,                        /* -version */
  OPT_w = 1107,                              /* -w */
  OPT_wrapper = 1108,                        /* -wrapper */
  OPT_x = 1109,                              /* -x */
  OPT_z = 1110,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
